...
| `docs/` | Setup guides, architecture, privacy policy, ToS. `cost-management.md` scopes the cost tracking/guardrails across AWS/Anthropic/GCP. `design-semantic-search.md` is the designed-but-not-built scrapbook search layer. |
